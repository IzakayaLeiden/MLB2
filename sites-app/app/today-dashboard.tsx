...
type FeedResponse = { available: boolean; state: "available" | "empty" | "unavailable"; reason?: string | null; feed?: Feed | null };
...
export function TodayDashboard() {
  ...
  return (
    <div className="dashboard-page">
      ...
      <div className="data-standard">▱&nbsp; 데이터 기준 {updated} ET · {feed?.model_version || "model-v1"} · 원시 확률</div>
      ...
      <section className="explanation-band">
        <div className="explanation-copy"><h2>이 확률은 어떻게 만들어지나요?</h2><div className="explanation-items"><p><b>경기 전 데이터만</b><span>Elo, 시즌 및 최근 성적, 득실점, 휴식일만 사용합니다.</span></p><p><b>날짜 단위 검증</b><span>같은 날 결과가 다른 경기 피처에 들어가지 않습니다.</span></p><p><b>배포 전 미래 검증</b><span>30일·300경기 섀도 게이트 전에는 공개하지 않습니다.</span></p></div></div>
